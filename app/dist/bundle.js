...
class Component {
    ...
    attach(insertAtBeginning) {
        this.hostElement.insertAdjacentElement(insertAtBeginning ? "beforebegin" : "beforeend", this.element);
    }
}
...
class ProjectInput extends _base_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    submitHandler(event) {
        ...
        if (Array.isArray(userInput)) {
            ...
            _state_project_state__WEBPACK_IMPORTED_MODULE_3__.projectState.addProject(title, description, manday);
            this.clearInput();
        }
    }
}
